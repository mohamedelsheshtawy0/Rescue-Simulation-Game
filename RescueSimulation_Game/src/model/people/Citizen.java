...
public class Citizen implements Rescuable,Simulatable{
	...
	public String toString(){
		String x="Citizen's Location : ("+this.getLocation().getX()+","+this.getLocation().getY()+"). \n";
		x+="Citizen's Name : "+this.getName()+". \n";
		x+="Citizen's Age : "+this.getAge()+". \n";
		x+="Citizen's ID : "+this.getNationalID()+". \n";
		x+="Citizen's HP : "+this.getHp()+". \n";
		x+="Citizen's BloodLoss : "+this.getBloodLoss()+". \n";
		x+="Citizen's Toxicity : "+this.getToxicity()+". \n";
		x+="Citizen's State : "+this.getState()+". \n";
		if (this.getDisaster()instanceof Infection){
			x+="Citizen's Disaster : Infection. \n";
		}
		if (this.getDisaster() instanceof Injury){
			x+="Citizen's Disaster : Injury. \n";
		}
		return x;
	}
}